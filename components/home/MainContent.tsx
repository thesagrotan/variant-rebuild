...
export const MainContent = ({ onProjectClick }: MainContentProps) => {
    ...
    return (
        <div className={cn("Chat", styles.containers.chat.wrapper)}>
            ...
            <div ref={scrollRef} onScroll={handleScroll} className="MainContent-scrollArea h-screen flex flex-col gap-4 pt-[80vh] justify-start overflow-scroll scrollbar-hide text-white mx-auto pb-32">
